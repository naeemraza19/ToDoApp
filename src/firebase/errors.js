export default {
  ...
  'invalid-credential':
    'The request does not have valid authentication credentials for the operation.',
  'invalid-token': 'The token is malformed or expired.',
  'need-permission':
    'The app does not have the appropriate permission to access the specified resource.',
  'need-user-id':
    'The app does not have the appropriate permission to access the specified resource.',
  'auth-domain-config-required':
    'Authentication configuration is not correct. Please check your project configuration.',
  'cors-unsupported':
    'This browser does not support cross-origin HTTP requests.',
  'operation-not-allowed':
    'The operation is not allowed. For example, adding a public document without appropriate permissions.',
  'web-storage-unsupported':
    'This browser is not supported or 3rd party cookies and data may be disabled.',
  ...
  'invalid-custom-token':
    'The custom token format is incorrect. Please check the documentation.',
  'invalid-dynamic-link-domain':
    'The provided dynamic link domain is not configured or is not allowed. Please check the documentation.',
  'invalid-email': 'The email address is badly formatted.',
  'invalid-api-key':
    'The API key is invalid. Please check your project configuration.',
  'invalid-credential':
    'The credential provider returned an invalid credential.',
  'invalid-message-payload':
    'The message payload is invalid. Please check the documentation.',
  'invalid-oauth-provider':
    'The OAuth provider is invalid. Please check the documentation.',
  'invalid-oauth-client-id': 'The OAuth client ID provided is invalid.',
  'invalid-oauth-client-secret': 'The OAuth client secret provided is invalid.',
  'invalid-oauth-credential':
    'The OAuth credential is malformed or has expired.',
  'invalid-oauth-token': 'The OAuth token is malformed or has expired.',
  'invalid-provider-id': 'The provider ID is invalid.',
  'invalid-recipient-email': 'The recipient email is invalid.',
  'invalid-sender': 'The email address is badly formatted.',
  'invalid-sender-email': 'The sender email address is invalid.',
  'invalid-action-code':
    'The action code is invalid. Please check the documentation.',
  'invalid-message-template':
    'The message template is invalid. Please check the documentation.',
  'invalid-oauth-provider':
    'The OAuth provider is invalid. Please check the documentation.',
  'invalid-oauth-client-id': 'The OAuth client ID provided is invalid.',
  'invalid-oauth-client-secret': 'The OAuth client secret provided is invalid.',
  ...
  'auth/invalid-oauth-response type':
  ...
  'auth/invalid-cordova-configuration':
    'The following Cordova plugins must be installed to enable OAuth sign-in: cordova-plugin-build info, cordova-universal-links-plugin, cordova-plugin-browser tab, cordova-plugin-inappbrowser and cordova-plugin-customurlscheme.',
